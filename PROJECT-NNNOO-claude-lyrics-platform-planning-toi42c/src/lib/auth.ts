...
export const getSession = cache(async (): Promise<User | null> => {
  ...
  // Every public page now asks whether the reader can edit. No session
  // cookie means the answer is no without a network round trip, which keeps
  // anonymous page loads — almost all of them — free of an auth call.
