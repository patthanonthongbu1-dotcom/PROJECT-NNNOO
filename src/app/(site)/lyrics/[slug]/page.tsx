    ...
    <article>
      ...
      <header className="flex flex-col gap-6 bg-gradient-to-b from-surface-3 to-transparent p-6 pt-12 sm:flex-row sm:items-end sm:p-8">
        ...
        <div className="min-w-0">
          ...
          <h1 className="mt-2 text-4xl font-black break-words text-ink sm:text-5xl lg:text-6xl">
            {track.title}
          </h1>
      ...
      <div className="p-6 sm:p-8">
        <LyricsView lyrics={track.lyrics} annotations={track.annotations} />
        ...
        {track.credits.length > 0 && <Credits credits={track.credits} />}
      </div>
    </article>
  )
}
